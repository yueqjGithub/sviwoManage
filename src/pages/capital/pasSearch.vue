      ...
      <el-row>
        <el-col :span="7">
          <el-form-item label="乘客手机号">
            <el-input v-model="searchOptions.userMobile" placeholder="司机手机号"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="7" :offset="3">
          <el-form-item label="乘客真实姓名">
            <el-input v-model="searchOptions.prealName" placeholder="司机真实姓名"></el-input>
          </el-form-item>
        </el-col>
      ...
      <el-row>
        ...
        <el-col :span="7" :offset="3">
          <el-form-item label="乘客id">
            <el-input v-model="searchOptions.passengerId" placeholder="乘客id"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
  ...
  export default {
    ...
    methods:{
      ...
      searchOption: function () {
        let vm = this
        let opts = {
          userMobile:  vm.searchOptions.userMobile,
